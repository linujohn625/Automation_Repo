...
public class Class5BugScenario  extends BaseTest{
	 @Test
	    public void verifyPaymentMethodsBug() {
	        ReusableMethod reusable = new ReusableMethod(driver);

	        // 1️. Login first (if not already logged in)
	        ...
	        // 5️.Validate that no selectable options exist
